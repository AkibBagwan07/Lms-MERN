    ...
    <footer className='bg-gray-900 md:px-36 text-left w-full mt-10'>
      ...
      '>
        <div className='flex flex-col md:items-start items-center w-full'>
          ...
          <p className='mt-6 text-center md:text-left text-sm text-white/80'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vero, porro molestias, veritatis deleniti necessitatibus exercitationem suscipit sapiente esse alias fugit soluta numquam dolorem maxime corporis nesciunt ipsum repudiandae eaque nemo?</p>
        </div>
        <div className='flex flex-col md:items-start items-center w-full'>
      ...
      <p className='py-4 text-center text-xs md:text-sm text-white/60'>Copyright 2025 © Learnary. All Right Reserved.</p>
    </footer>
  )
}
